...
//                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
    ...
    private void updateUI(GoogleSignInAccount account) {
        ...
        socialLogin(name, email, String.valueOf(photoUri));
    }

    private void socialLogin(String name, String email, String pic) {
        if (App.isOnline()) {
            progressDialog.show();
            startActivity(new Intent(LoginActivity.this, MainActivity.class));
            Call<UserDetailResponse> userResponseCall = apiInterface.socialLogin(name, email, pic, "Google", AppUtil.getDeviceId(this), AppUtil.getFCMToken(this));

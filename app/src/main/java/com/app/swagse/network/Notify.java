...
import static com.app.swagse.network.ResourcesHelper.getStringResourceByKey;
...
public class Notify {
    ...
    private Notify(Context _context){
        ...
        try{
            this.channelId = getStringResourceByKey(context, Notify.ChannelData.ID);
        } catch (Resources.NotFoundException e){
            this.channelId = "NotifyAndroid";
        }

        try {
            this.channelName = getStringResourceByKey(context, Notify.ChannelData.NAME);
        } catch (Resources.NotFoundException e) {
            this.channelName = "NotifyAndroidChannel";
        }

        try{
            this.channelDescription = getStringResourceByKey(context, Notify.ChannelData.DESCRIPTION);
        } catch (Resources.NotFoundException e) {
